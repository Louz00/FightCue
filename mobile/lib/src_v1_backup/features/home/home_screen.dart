...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final mergedListenable = Listenable.merge([
      widget.snapshotListenable,
      widget.syncingListenable,
      widget.syncErrorListenable,
      widget.cachedFallbackListenable,
      widget.lastSyncedAtListenable,
    ]);

    return AnimatedBuilder(
      animation: mergedListenable,
      builder: (context, _) {
        final snapshot = widget.snapshotListenable.value;
        final isSyncing = widget.syncingListenable.value;
        final hasSyncError = widget.syncErrorListenable.value;
        final usingCachedFallback = widget.cachedFallbackListenable.value;
        final lastSyncedAt = widget.lastSyncedAtListenable.value;
